class KFTHPGiveWeaponCommand extends KFTHPBinaryTargetCommand;
    ...
    (KFTHPCommandExecutionState ExecState, PlayerController PC)
{
    ...
    KFTHPCommandPreservedState(ExecState).SaveString(WeaponClass.default.ItemName);
}
...
protected function string GetTargetSuccessMessage(KFTHPCommandExecutionState ExecState)
{
    ...
    WeaponName = KFTHPCommandPreservedState(ExecState).LoadString();
