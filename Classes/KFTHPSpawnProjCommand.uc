class KFTHPSpawnProjCommand extends KFTHPCommand;
...
protected function DoAction(KFTHPCommandExecutionState ExecState)
{
    ...
    ProjType = KFTHPCommandPreservedState(ExecState).LoadString();
...
protected function bool CheckArgs(KFTHPCommandExecutionState ExecState)
{
    ...
    for (i = 0; i < AvailableProjTypes.Length; i++)
    {
        ...
        {
            KFTHPCommandPreservedState(ExecState).SaveString(AvailableProjTypes[i]);
            return true;
        }
    }
